<template>
  <NuxtLink
    ...
    :style="{ backgroundColor: '#0c2442' }"
  >
    <!--    style='background: linear-gradient(to right, #0c2442, #4f7492);'>-->
    <div class="font-roboto lg:container lg:mx-auto">
      <div
        class="h-12 relative flex items-center justify-center text-xs mx-4 md:mx-10 md:text-sm lg:text-base lg:mx-0 text-white"
      >
        <div class="w-8 md:absolute md:left-0">
          <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <circle
              cx="12"
              cy="12"
              r="10"
              class="text-green-200 fill-current dark:text-green-700"
            />
            <path
        ...
        <div class="flex items-center justify-center space-x-2 md:space-x-4">
          <div class="hidden md:block">
            <img src="/img/banners/cup.png" class="w-8" />
          </div>
          <i18n
            path="banner.now"
            tag="p"
            class="leading-tight font-bold max-w-72 text-xs md:text-base md:max-w-full"
          >
            <template #available>
          ...
          <div class="flex items-center">
            <button
              ...
              class="font-bold uppercase bg-orange-500 hover:bg-orange-600 text-white no-underline inline-block px-3 py-1 text-sm uppercase rounded"
            >
              {{ $t('banner.contact') }}
            </button>
          </div>
